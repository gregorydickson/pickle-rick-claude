...
export async function runCitadelAudit(options) {
    ...
    if (persistError !== null) {
        ...
        process.stderr.write(`[citadel] report NOT written to ${reportPath}: ${persistError} — the audit measured `
 ...
 */
async function persistCitadelReport(reportPath, sessionDir, report) {
