...
/** B2 (ticket a7a029df): result of re-asking the API whether a rate limit still holds. */
...
function resolveMuxRateLimitProbeIntervalMs(env: NodeJS.ProcessEnv = process.env): number {
