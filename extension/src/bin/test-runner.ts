 ...
 */
function buildTestSpawnOptions(disposableTmpRoot: string | null): SpawnSyncOptions & { detached?: boolean } {
  return {
    stdio: 'inherit',
 ...
 */
function removeDisposableTmpRoot(disposableTmpRoot: string | null): void {
  if (!disposableTmpRoot) return;
  try {
