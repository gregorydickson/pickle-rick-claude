...
export function measuredTestCount(stdout, stderr) {
 ...
 * the regression.
 */
export function reportedTestResults(stdout, stderr) {
...
export function normalizeMicroverseExitReason(reason) {
    return LEGACY_MICROVERSE_EXIT_REASON_RENAMES[reason] ?? reason;
}
 ...
 */
const DEFAULT_EXIT_DISPOSITION = { verdict: 'unknown', haltEligible: false, crashFloor: false };
/**
 ...
 */
export const CRASH_FLOOR_EXIT_REASONS = EXIT_REASONS.filter((reason) => EXIT_DISPOSITIONS[reason].crashFloor);
/**
