...
// Caps measured, not guessed. Isolated runs: 62621ms / 71653ms / 82387ms; in-tier
// under `test:integration:serial` at HEAD cdbbb3a2: 84062ms. Inner spawnSync cap =
// round5s(84062 * 1.6) = 135000ms — a 60% margin over the slowest run, covering
// contention with concurrent codex/tmux work. Outer node-test timeout = inner +
// 15000ms = 150000ms, so the inner cap always fires first and reports the signal.
// The test verifies "subprocess completes without SIGTERM at worker_timeout_seconds=1s";
// the fake claude sleeps 1200ms. The wall-clock budget is not the assertion — the
// artifact-existence check is.
