...
const MICROVERSE_RUNNER_EVENTS = ['judge_unreachable', 'judge_timeout', 'judge_measurement_attempted', 'baseline_attempt_timeout', 'metric_unmeasurable', 'judge_cli_missing'];
