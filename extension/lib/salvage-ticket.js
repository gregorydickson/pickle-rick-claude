 ...
 */
export function salvageTicket(input, depsIn = {}) {
    ...
    const definedOverrides = Object.fromEntries(Object.entries(depsIn).filter(([, v]) => v !== undefined));
    const deps = { ...defaultDeps, ...definedOverrides };
    const log = input.log ?? (() => { });
    try {
