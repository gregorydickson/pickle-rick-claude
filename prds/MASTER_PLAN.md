...
gate converged over tsc-RED commits — now the ONLY open actionable reliability fix (mechanism-verify
first, route through the existing `runGate` seam). Prior window (beta.37): the three 2026-07-02 capture-only bugs
