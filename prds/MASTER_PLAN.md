...
**A. Reliability-fix queue — ✅ DRAINED AGAIN (2026-07-02, beta.37).** The three 2026-07-02 capture-only bugs
...
**▶ THE IMMEDIATE NEXT STEP stays the field-soak (now on beta.38):** ✅ **codex rep #1 BANKED CLEAN**
(B-SCOPESEED 2026-07-02: 4/4 hands-off, 139m, zero intervention — the run the track-C gate wanted).
Remaining soak: ≥1 claude rep with a genuine >600s ticket + ≥1 more codex rep for repeatability. The GA
bar stays N bundles hands-off in a row. **Ledger caveat:** "hands-off 4/4" ≠ toolchain-green —
[[R-SZGB]] (P2) shows a converged szechuan run can ship tsc-RED commits that only the closer's full gate
catches; drain R-SZGB before trusting review-phase exits.
