...
**▶ STATE: clean. `origin/main` = v2.0.0-beta.33 (HEAD `be95d1e9`); tree clean; no active pipeline; runtime deployed.**
...
| Item | Value |
|---|---|
| Version (source = deployed) | **v2.0.0-beta.33** — gate-overreach subtraction (Phase 1 advisory readiness/ticket-audit gates `87d837f6` + Phase 2 deleted forward-ref annotation grammar `9a5c047e`); deployed via install.sh 2026-06-30. Prior: beta.32 R-LTDM detached-poll throttle · beta.31 R-MWBG runtime half. |
| Latest GitHub release | **v2.0.0-beta.33** (gate-overreach subtraction; prerelease). Prior: beta.32 R-LTDM · beta.31 R-MWBG runtime half · beta.30 B-RELHYG · beta.29 R-SIGF+R-MWBG-half-1 · beta.28 R-WPEX · beta.27 B-APNC. |
