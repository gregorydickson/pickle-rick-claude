...
| Item | Value |
|---|---|
| Version (source = deployed) | **v2.0.0-beta.31** — R-MWBG runtime half (explicit-tier detached-routing gate; `tierExceedsBashCeiling`); fix `64fb7e12`, built interactively, deployed via install.sh 2026-06-29. Prior: beta.30 B-RELHYG reliability hygiene. |
