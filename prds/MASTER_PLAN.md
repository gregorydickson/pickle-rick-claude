...
> moved to `archive/bundles` + `archive/bug-reports`. R-PFNT / R-CECX stay above as **code-fixed-pending-codex-proof**
> residuals (not new work). The 2026-06-24 sweep also archived ~30 older shipped PRDs/design-notes.
>
